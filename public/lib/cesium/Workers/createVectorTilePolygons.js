...
define(['./AttributeCompression-42df7d39', './Cartesian2-15709417', './Color-e465730a', './when-54c2dc71', './IndexDatatype-eaebd63b', './Math-fbfbe3b1', './OrientedBoundingBox-c277851a', './createTaskProcessorWorker', './Check-6c0211bc', './Transforms-c00dcfdd', './RuntimeError-2109023a', './WebGLConstants-76bb35d1', './EllipsoidTangentPlane-989039a6', './IntersectionTests-9d9af9db', './Plane-ff99a7c3'], function (AttributeCompression, Cartesian2, Color, when, IndexDatatype, _Math, OrientedBoundingBox, createTaskProcessorWorker, Check, Transforms, RuntimeError, WebGLConstants, EllipsoidTangentPlane, IntersectionTests, Plane) { 'use strict';
