...
define(['./AttributeCompression-42df7d39', './Cartesian2-15709417', './IndexDatatype-eaebd63b', './Math-fbfbe3b1', './createTaskProcessorWorker', './Check-6c0211bc', './when-54c2dc71', './WebGLConstants-76bb35d1'], function (AttributeCompression, Cartesian2, IndexDatatype, _Math, createTaskProcessorWorker, Check, when, WebGLConstants) { 'use strict';
