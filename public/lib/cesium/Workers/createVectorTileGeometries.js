...
define(['./Transforms-c00dcfdd', './BoxGeometry-929ba9cd', './Cartesian2-15709417', './Color-e465730a', './CylinderGeometry-a6a85d94', './when-54c2dc71', './EllipsoidGeometry-8f202aa1', './IndexDatatype-eaebd63b', './createTaskProcessorWorker', './Check-6c0211bc', './Math-fbfbe3b1', './RuntimeError-2109023a', './GeometryOffsetAttribute-b31a3ff4', './ComponentDatatype-a26dd044', './WebGLConstants-76bb35d1', './GeometryAttribute-c2f3a6a0', './GeometryAttributes-4fcfcf40', './VertexFormat-4d8b817a', './CylinderGeometryLibrary-01dd6112'], function (Transforms, BoxGeometry, Cartesian2, Color, CylinderGeometry, when, EllipsoidGeometry, IndexDatatype, createTaskProcessorWorker, Check, _Math, RuntimeError, GeometryOffsetAttribute, ComponentDatatype, WebGLConstants, GeometryAttribute, GeometryAttributes, VertexFormat, CylinderGeometryLibrary) { 'use strict';
