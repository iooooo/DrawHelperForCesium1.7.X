...
define(['./AttributeCompression-42df7d39', './Cartesian2-15709417', './Math-fbfbe3b1', './createTaskProcessorWorker', './Check-6c0211bc', './when-54c2dc71'], function (AttributeCompression, Cartesian2, _Math, createTaskProcessorWorker, Check, when) { 'use strict';
