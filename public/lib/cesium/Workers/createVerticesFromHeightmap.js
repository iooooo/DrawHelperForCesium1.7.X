...
define(['./Cartesian2-15709417', './EllipsoidTangentPlane-989039a6', './Transforms-c00dcfdd', './when-54c2dc71', './Check-6c0211bc', './TerrainEncoding-e4132b66', './Math-fbfbe3b1', './OrientedBoundingBox-c277851a', './WebMercatorProjection-0e9a0efb', './RuntimeError-2109023a', './createTaskProcessorWorker', './IntersectionTests-9d9af9db', './Plane-ff99a7c3', './AttributeCompression-42df7d39', './ComponentDatatype-a26dd044', './WebGLConstants-76bb35d1'], function (Cartesian2, EllipsoidTangentPlane, Transforms, when, Check, TerrainEncoding, _Math, OrientedBoundingBox, WebMercatorProjection, RuntimeError, createTaskProcessorWorker, IntersectionTests, Plane, AttributeCompression, ComponentDatatype, WebGLConstants) { 'use strict';
